        ...
        <tr>
            <td valign="top" align="center">
                <table border="0" style="width: 98%;">
                    <tr id="trSearchLink">
                        <td align="left">
                            <a href="#" id="lnkSearch" onclick="ShowSearch('cphMaster_hdnShowSearch',1)">Search</a>
                        </td>
                    </tr>
                    <tr id="trSearch" style="display: none;">
                        <td style="white-space: nowrap; width: 100%; text-align: left;">
                            <div id="divSearch" runat="server">
                                <ctl:Text2 ID="txtID" runat="server" Required="false" Width="30" Label="ID: " />
                                <ctl:DDown2 ID="ddlCompanyID" runat="server" Required="false" Label="Company: " />
                                <ctl:Text2 ID="txtCustomerRefNo" runat="server" Required="false" Width="50" Label="Client Ref Number: " />
                                ...
                                <asp:Button ID="btnCancel" Text="Close" CssClass="Button" runat="server" OnClientClick="ShowSearch('cphMaster_hdnShowSearch',0); return false;" />
                            </div>
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <ctl:Button ID="btnChangeStatus" Text="Change Status" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <asp:GridView ID="grvDataTable1" CssClass="gridTable" runat="server" ShowFooter="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField SortExpression="ID" HeaderText="ID">
                                        <ItemTemplate>
                                            <a runat="server" href='<%# GetRedirectURL(UIConstants.RecordCaseAspx ,QueryStringConstants.RecordID , Eval("ID"))%>' title='<%# Eval("ID")%>'>
                                                <%# Eval("ID")%></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:BoundField DataField="CustomerRefNo" HeaderText="Client Ref Number" SortExpression="CustomerRefNo" />
                                    ...
                                    <asp:BoundField DataField="CaseCount" HeaderText="Current Result" SortExpression="CaseCount" />
                                    ...
                                    <asp:TemplateField HeaderText="Report">
                                        <ItemTemplate>
                                            <a href='javascript:opennewindow("<%# GetRedirectURL(UIConstants.ReportAspx ,QueryStringConstants.RecordID , Eval("ID"))%>", "Report");'>
                                                Generate</a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
