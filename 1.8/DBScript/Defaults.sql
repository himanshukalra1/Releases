...
UPDATE Record_Status_Type SET Name = 'RESEARCH', Value = 'RESEARCH', SortOrder = 1 WHERE ID = 1
ELSE
INSERT INTO Record_Status_Type(ID, Name, Value, SortOrder) VALUES (1, 'RESEARCH', 'RESEARCH', 1)
GO
IF EXISTS(SELECT ID FROM Record_Status_Type WHERE ID = 2)
UPDATE Record_Status_Type SET Name = 'DISPO', Value = 'DISPO', SortOrder = 2 WHERE ID = 2
ELSE
INSERT INTO Record_Status_Type(ID, Name, Value, SortOrder) VALUES (2, 'DISPO', 'DISPO', 2)
GO
IF EXISTS(SELECT ID FROM Record_Status_Type WHERE ID = 3)
UPDATE Record_Status_Type SET Name = 'QA', Value = 'QA', SortOrder = 4 WHERE ID = 3
ELSE
INSERT INTO Record_Status_Type(ID, Name, Value, SortOrder) VALUES (3, 'QA', 'QA', 4)
GO
IF EXISTS(SELECT ID FROM Record_Status_Type WHERE ID = 4)
UPDATE Record_Status_Type SET Name = 'SUBMIT', Value = 'SUBMIT', SortOrder = 5 WHERE ID = 4
ELSE
INSERT INTO Record_Status_Type(ID, Name, Value, SortOrder) VALUES (4, 'SUBMIT', 'SUBMIT', 5)
GO
IF EXISTS(SELECT ID FROM Record_Status_Type WHERE ID = 5)
UPDATE Record_Status_Type SET Name = 'ARCHIVE', Value = 'ARCHIVE', SortOrder = 6 WHERE ID = 5
ELSE
INSERT INTO Record_Status_Type(ID, Name, Value, SortOrder) VALUES (5, 'ARCHIVE', 'ARCHIVE', 6)
GO
IF EXISTS(SELECT ID FROM Record_Status_Type WHERE ID = 6)
UPDATE Record_Status_Type SET Name = 'CANCEL', Value = 'CANCEL', SortOrder = 7 WHERE ID = 6
ELSE
INSERT INTO Record_Status_Type(ID, Name, Value, SortOrder) VALUES (6, 'CANCEL', 'CANCEL', 7)
GO
IF EXISTS(SELECT ID FROM Record_Status_Type WHERE ID = 7)
UPDATE Record_Status_Type SET Name = 'OUTSOURCED', Value = 'OUTSOURCED', SortOrder = 3 WHERE ID = 7
ELSE
INSERT INTO Record_Status_Type(ID, Name, Value, SortOrder) VALUES (7, 'OUTSOURCED', 'OUTSOURCED', 3)
GO
IF EXISTS(SELECT ID FROM Record_Status_Type WHERE ID = 8)
UPDATE Record_Status_Type SET Name = 'DUPLICATE', Value = 'DUPLICATE', SortOrder = 8 WHERE ID = 8
ELSE
INSERT INTO Record_Status_Type(ID, Name, Value, SortOrder) VALUES (8, 'DUPLICATE', 'DUPLICATE', 8)
GO
...
GO
IF EXISTS(SELECT ID FROM Plea_Type WHERE ID = 4)
UPDATE Plea_Type SET Name = 'Forfeiture', Value = 'Forfeiture' WHERE ID = 4
ELSE
INSERT INTO Plea_Type(ID, Name, Value) VALUES (4, 'Forfeiture', 'Forfeiture')
GO
...
UPDATE County SET Name = 'CALAVERAS', Value = 'CALAVERAS' WHERE ID = 5
ELSE
INSERT INTO County(ID, Name, Value) VALUES (5, 'CALAVERAS', 'CALAVERAS')
GO
