                                    ...
                                    <asp:GridView ID="grvCaseRecord" runat="server" ShowFooter="false" DataKeyNames="ID"
                                        ...
                                        <Columns>
                                           ...
                                           <%-- <asp:TemplateField ItemStyle-Width="48px" HeaderText="Jail Credit">
                                                ...
                                                <EditItemTemplate>
                                                    <ctl:Text2 ID="txtJailCredit" runat="server" Value='<%# Bind("JailCredit") %>'
                                                        />
                                                </EditItemTemplate>
                                            </asp:TemplateField>--%>
                                            <asp:TemplateField ItemStyle-Width="100px" HeaderText="Sentencing Detail">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSentencingDetail" runat="server" Text='<%# Bind("SentencingDetail") %>'></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <ctl:Text2 ID="txtSentencingDetail" runat="server" Value='<%# Bind("SentencingDetail") %>' TextMode="MultiLine"
                                                        Width="180" Height="50"/>
                                                </EditItemTemplate>
                                            </asp:TemplateField>
