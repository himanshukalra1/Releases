<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="Interfaces.aspx.cs" Inherits="GMPortal.Entity.Interfaces"
...
<asp:Content ContentPlaceHolderID="cphMaster" ID="cnPage" runat="server">
    <table>
        <tr>
            <td>
                <ctl:PageTitle ID="pgTitle" runat="server" Label="Interfaces" />
            </td>
        </tr>
        <tr>
            <td>&nbsp;
