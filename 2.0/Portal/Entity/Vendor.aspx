                ...
                <table style="width: 50%;">
                                                ...
                                                <asp:GridView ID="grvCountyRate" runat="server" ShowFooter="false" DataKeyNames="ID" AutoGenerateColumns="false" OnRowCancelingEdit="OnCancel"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField ItemStyle-Width="136px" HeaderText="County Assigned">
                                                            <ItemTemplate>
                                                                <ctl:DDown2 ID="ddlCountyIDRead" runat="server" Width="80" DataTextField="Name" DataValueField="ID" Enabled="false" DataSource='<%# Bind("DSCountyID") %>' Value='<%# Bind("CountyID") %>' />
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <ctl:Button ID="btnBilling" Text="Billing" runat="server" />
