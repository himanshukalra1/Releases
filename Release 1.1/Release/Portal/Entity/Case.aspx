                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <table>
                                ...
                                <ctl:Text ID="txtStatusJudgment" runat="server" Label="Status/Judgmentl:" Required="false" Width="140" />
                            </table>
                        </td>
                        <td  valign="top">
                            <table>
                                    ...
                                    OnRowDeleting="OnDelete" OnRowEditing="OnEdit" OnRowUpdating="OnUpdate" HeaderStyle-CssClass="GridHeader" AlternatingRowStyle-CssClass="GridAltItem">
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="192px" HeaderText="Description">
                                                ...
                                                <EditItemTemplate>
                                                    <ctl:Text2 ID="txtDescription" runat="server" Value='<%# Bind("Description") %>' Width="180" />
                                                </EditItemTemplate>
                                            </asp:TemplateField>
