...
IF NOT EXISTS (SELECT 'X' FROM INFORMATION_SCHEMA.COLUMNS WHERE COLUMN_NAME IN ('UseInSearch') AND TABLE_NAME IN ('Record_Address'))
	ALTER TABLE DBO.[Record_Address] Add UseInSearch BIT NULL
GO

IF NOT EXISTS (SELECT 'X' FROM INFORMATION_SCHEMA.COLUMNS WHERE COLUMN_NAME IN ('UseInSearch') AND TABLE_NAME IN ('Record_Names'))
	ALTER TABLE DBO.[Record_Names] Add UseInSearch BIT NULL
GO