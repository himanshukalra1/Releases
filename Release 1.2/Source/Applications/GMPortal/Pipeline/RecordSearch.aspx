                    ...
                    <tr>
                        <td>
                            <asp:HiddenField ID="hdnSearch" runat="server" Value="" />
                             <asp:HiddenField ID="hdnIsCivil" runat="server" Value="" />
                            &nbsp;
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <asp:GridView ID="grvDataTable" CssClass="gridTable" runat="server" ShowFooter="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="OldResult" HeaderText="Old Result" />
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <tr>
                                                <td colspan="100%" align="right">
                                                    <div style="width: 90%">
                                                        ...
                                                        <asp:GridView ID="gvRecordCase" CssClass="gridTable" HeaderStyle-CssClass="GridHeader"
                                                            RowStyle-CssClass="GridItem" AlternatingRowStyle-CssClass="GridAltItem" runat="server"
                                                                AutoGenerateColumns="False" DataSourceID="odsRecordCaseData" OnLoad="gvRecordCaseLoad">
                                                            <Columns>
