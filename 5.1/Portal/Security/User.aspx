                    ...
                    <tr>
                        <td valign="top" style="width: 50%">
                            <table border="0">
                                ...
                                <ctl:text id="txtDailySalary" runat="server" label="Daily Wages" validationtype="DecimalNumber" maxlen="7" Visible="false" />
                        ...
                        <td>
                         ...
                         <td valign="top" align="left">
                            <table border="0">
                                <tr>
                                    <td valign="top" align="left">
                                        <ctl:twolist id="tltRecordStatusTypes" runat="server" title="Status" SelectedInstanceId="lstRecordStatusTypesSelected" UNSelectedInstanceId="lstRecordStatusTypesUNSelected"/>
                                    </td>
                                </tr>
                            </table>
                        </td>
