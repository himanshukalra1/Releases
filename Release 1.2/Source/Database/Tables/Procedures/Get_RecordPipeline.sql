...
SET @SqlString	=  @SqlString + ' GROUP BY B.ID,C.Name, B.ReceivedDate, B.CreatedDate, B.CustomerRefNo,RS.Name,B.County,B.Name,B.DOB,CS.Name,B.Years,A.Name,B.ClientRemarks,B.ClientSplRemarks, CY.Name'
