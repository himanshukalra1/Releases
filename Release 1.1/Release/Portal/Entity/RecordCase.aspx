                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <table>
                                ...
                                <ctl:Text ID="txtCounty" runat="server" Label="County:" Required="true" Width="200" />
                                ...
                                <ctl:Text ID="txtSSN" runat="server" Label="SSN:" Required="false" Width="200" ValidationType="Number" />
                                <ctl:Text ID="txtPrintCost" runat="server" Label="Print Cost:" Required="false" Width="200" Blur="calculatetotalcost();"
                                    ValidationType="DecimalNumber" />
                                <ctl:Text ID="txtNoOfPages" runat="server" Label="No Of Pages:" Required="false" Blur="calculatetotalcost();"
                                    Width="200" ValidationType="Number" />
                                <ctl:Text ID="txtTotalCost" runat="server" Label="Total Cost: $" Required="false" Width="200"
                                    ReadOnly="true" />
                                ...
                                <tr>
                                    <td>
                                        <asp:GridView ID="grvHistory" runat="server" ShowFooter="false" AutoGenerateColumns="false"
                                            HeaderStyle-CssClass="GridHeader" AlternatingRowStyle-CssClass="GridAltItem" Width="240">
                                            <Columns>
