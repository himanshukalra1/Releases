                        ...
                        <td valign="top" style="width:25%">
                            <table>
                                ...
                                <ctl:Text ID="txtSpecialFee" runat="server" Label="Special Fee: $" Required="false" Width="200"
                                    ValidationType="DecimalNumber" />
                                <ctl:Text ID="txtSalary" runat="server" Label="Salary:" Required="false"
                                    Width="200" TextMode="MultiLine" Height="35" />
                                    ...
                                    <td>
                                        <asp:GridView ID="grvUIRecordAddress" runat="server" ShowFooter="false" AutoGenerateColumns="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="AddressL2" HeaderText="Address L2" />
