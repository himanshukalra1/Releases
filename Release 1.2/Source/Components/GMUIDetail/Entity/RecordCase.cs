namespace GMUIDetail.Entity
{
	...
	public class DCRecordCase : Base.BaseDC
	{
		...
		[DataMember]
        public string CaseType { get { return m_actualcasetype; } set { m_actualcasetype = value; } }
        ...
        private bool m_iscivil;
        [DataMember]
        public bool IsCivil { get { return m_iscivil; } set { m_iscivil = value; } }
		#endregion
	}
}
