...
SET NOCOUNT ON  
 ...
 SUBSTRING(br.ClientRemarks,0,10000),  
 SUBSTRING(br.ClientSplRemarks,0,10000),      
 br.RISComments,    
 ...
 br.SSN,at.Name ,v.Name ,ct2.Name , br.ClientRemarks, br.ClientSplRemarks, br.RISComments, rh.CreatedDate,st.Name     
